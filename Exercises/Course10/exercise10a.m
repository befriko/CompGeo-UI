...
% Modified for Octave by Befriko Murdianto, 2020
% 1st revision: Oct 24, 2020
%               Added simple fillmissing from https://sourceforge.net/projects/simple-fillmissing/
...
% Replace misfit with misfit_nonan if you're using fillmissing from this package
%pkg load tablicious
...
dx = 25 ;
v.Base = dlmread('../../Data/marm2/marm2_10.dat');
...
model.caxis = caxis;
figure;imagescc(v.Init,model,'Initial',[opts.figFolder,'init'])
...
fFactor = 1.5; % factor to the next frequncy
...
for iOut=1:3
    while freq<=fMax
        ...
        snrDB = immse(DClean, Dorig-DClean)
        matSNR  = db2pow(snrDB)
