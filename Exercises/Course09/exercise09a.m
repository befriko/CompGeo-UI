...
% on its measured gravity response (given distance x and \Deltag) after 1
% iteration. Octave compatible.
%
...
R=20; %initial value for the radius
b=40; %initial value for the depth
p=[R b]';
x=[-100 -50 0 50 100]';
%observed data
yobs=[-4.696e-7 -1.174e-6 -2.348e-6 -1.174e-6 -4.696e-7]';
beta=0; %just use Gauss-Newton
...
title('Inversion of gravity anomaly');
