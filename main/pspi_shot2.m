function [shotmigdec,shotmigcc,illumination]=pspi_shot2(shot,t,x,vel,xv,zv,xshot,frange,stab)
...
%     figure(3);
% %     imagesc(ifktran(fftshift(ftemp,2),f,k));
%    imagesc(abs(real(sum(stemp)+sum(stemp(1:nf2-1,:)))/(2*nf2-1)));
%      
    figure(2);
    imagesc(shotmigcc(25:end,:));
end
