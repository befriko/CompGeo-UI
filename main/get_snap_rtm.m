function [snapshot,z,x]=get_snap_rtm(delx,delt,velocity,snap1,snap2,laplacian,boundary)
...
% edited by Wenyong Pan for reverse time migration, May 2013
%
...
%   snapshot=(2*velocity.^2.*delt).*del2_9pt(snap2,delx) + 2*snap2 - snap1;
